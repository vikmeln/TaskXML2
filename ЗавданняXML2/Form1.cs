    ...
    public partial class Form1 : Form
    {
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                ds.WriteXml("E:\\Алгоритмізація та програмування\\XMLFile1.xml");
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            {
                if (File.Exists("E:\\Алгоритмізація та програмування\\XMLFile1.xml"))
                {
                    DataSet ds = new DataSet();
                    ds.ReadXml("E:\\Алгоритмізація та програмування\\XMLFile1.xml");
